 ...
 */
public class ProfList extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.prof_list);
        ...
        switch (dept) {
            case 0:
                ...
                for (int j = 0; j < eceprofs.length; j++) {
                    ...
                    eceItems.add(item);
                    ProfListCustomListViewAdapter adapter = new ProfListCustomListViewAdapter(this,
                            R.layout.prof_list_item, eceItems);
